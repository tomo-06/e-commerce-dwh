...
*/
CREATE TABLE IF NOT EXISTS OLIST_DWH.RAW.OLIST_CUSTOMERS_DATASET (
    customer_id VARCHAR,
...
CREATE TABLE IF NOT EXISTS OLIST_DWH.RAW.OLIST_ORDERS_DATASET (
    order_id VARCHAR,
    customer_id VARCHAR,
...
CREATE TABLE IF NOT EXISTS OLIST_DWH.RAW.OLIST_PRODUCTS_DATASET (
    product_id VARCHAR,
...
CREATE TABLE IF NOT EXISTS OLIST_DWH.RAW.OLIST_SELLERS_DATASET (
    seller_id VARCHAR,
...
CREATE TABLE IF NOT EXISTS OLIST_DWH.RAW.OLIST_ORDER_ITEMS_DATASET (
    order_id VARCHAR,
...
CREATE TABLE IF NOT EXISTS OLIST_DWH.RAW.OLIST_ORDER_REVIEWS_DATASET (
    review_id VARCHAR,
    order_id VARCHAR,
...
CREATE TABLE IF NOT EXISTS OLIST_DWH.RAW.OLIST_ORDER_PAYMENTS_DATASET (
    order_id VARCHAR,
...
CREATE TABLE IF NOT EXISTS OLIST_DWH.RAW.OLIST_GEOLOCATION_DATASET (
...
CREATE TABLE IF NOT EXISTS OLIST_DWH.RAW.PRODUCT_CATEGORY_NAME_TRANSLATION (
    product_category_name VARCHAR,
